...
public class SimpleNoRotAttackAnimation extends AttackAnimation {
    public SimpleNoRotAttackAnimation(float ConvertTime, float antic, float preDelay, float contact, float recovery, @Nullable Collider collider, Joint colliderJoint, String path, Armature armature) {
        this(ConvertTime, antic, preDelay, contact, recovery, collider, colliderJoint, path, armature, false);
    }

    public SimpleNoRotAttackAnimation(float convertTime, float antic, float preDelay, float contact, float recovery, @Nullable Collider collider, Joint colliderJoint, String path, Armature armature, boolean directional) {
    ...
    public SimpleNoRotAttackAnimation(float convertTime, String path, Armature armature, AttackAnimation.Phase... phases) {
